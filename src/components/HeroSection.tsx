          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              {[
                ...
                { icon: Linkedin, href: 'https://www.linkedin.com/in/aditya-rai-4854742b8/', label: 'LinkedIn' },
                { icon: Mail, href: 'mailto:raiaditya915@gmail.com?subject=Hello Aditya&body=Hi Aditya,%0D%0A%0D%0AI wanted to connect with you regarding...', label: 'Email' },
